...
const AGENDA: AgendaItem[] = [
  {
    id: "1",
    time: "09:00",
    title: "Feb 8: Research Symposium (Bharat Mandapam)",
  },
  {
    id: "2",
    time: "11:30",
    title:
      "Feb 8: Industry Session - AI by HER: Global Impact Challenge (Sushma Swaraj Bhawan)",
  },
  {
    id: "3",
    time: "14:00",
    title: "Feb 8: Keynotes, Panel Discussions & Roundtables (Various Venues)",
  },
  {
    id: "4",
    time: "19:00",
    title: "Feb 8: Summit Dinner (Convention Centre, New Delhi)",
  },
  {
    id: "5",
    time: "10:00",
    title: "Feb 16: AI Impact Expo - Opening Day (Bharat Mandapam)",
  },
  {
    id: "6",
    time: "10:00",
    title: "Feb 17-20: AI Impact Expo - Ongoing Exhibitions (Bharat Mandapam)",
  },
];
    ...
    <div className="h-full flex flex-col bg-card rounded-xl border shadow-sm overflow-hidden">
      ...
      <div className="px-5 py-3 border-b bg-muted/20 flex flex-row items-center justify-between">
        ...
        <div className="flex items-center gap-3 text-sm font-mono font-medium text-muted-foreground">
          ...
          <span suppressHydrationWarning>
            {now.toLocaleDateString("en-IN", { timeZone: IST_TIMEZONE })}
          </span>
        </div>
      </div>
